...
impl crate::framework::Example for Example {
    ...
    fn init(
        ...
        let shader = device.create_shader_module(include_wgsl!("shader.wgsl")).unwrap();

        let blit_shader = device.create_shader_module(include_wgsl!("blit.wgsl")).unwrap();
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    ...
                    resource: wgpu::BindingResource::TextureView(
                        &storage_tex.create_view(&wgpu::TextureViewDescriptor::default()).unwrap(),
                    ),
                },
                wgpu::BindGroupEntry {
                    binding: 2,
    ...
    fn render(&mut self, view: &wgpu::TextureView, device: &wgpu::Device, queue: &wgpu::Queue) {
        ...
        encoder.build_acceleration_structures(None, Some(&self.tlas_package)).unwrap();

        {
            ...
            cpass.set_bind_group(0, Some(&self.bind_group), &[]).unwrap();
