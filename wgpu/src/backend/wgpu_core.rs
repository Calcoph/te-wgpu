...
impl dispatch::DeviceInterface for CoreDevice {
    ...
    ) -> Result<dispatch::DispatchExternalTexture, wgc::resource::CreateExternalTextureError> {
...
impl dispatch::CommandEncoderInterface for CoreCommandEncoder {
    ...
    fn begin_compute_pass(
        ...
        let pass = self.context.0.command_encoder_begin_compute_pass(
            self.id,
    ...
    fn begin_render_pass(
        ...
        let pass = self.context.0.command_encoder_begin_render_pass(
            self.id,
...
impl dispatch::RenderPassInterface for CoreRenderPass {
    ...
    fn draw_mesh_tasks(&mut self, group_count_x: u32, group_count_y: u32, group_count_z: u32) -> Result<(), wgc::command::RenderPassError> {
        self.context.0.render_pass_draw_mesh_tasks(
            &mut self.pass,
            group_count_x,
            group_count_y,
            group_count_z,
    ...
    fn draw_mesh_tasks_indirect(
        ...
        self.context.0.render_pass_draw_mesh_tasks_indirect(
            &mut self.pass,
            indirect_buffer.id,
            indirect_offset,
        )
    ...
    fn multi_draw_mesh_tasks_indirect(
        ...
        self.context.0.render_pass_multi_draw_mesh_tasks_indirect(
            &mut self.pass,
            indirect_buffer.id,
            indirect_offset,
            count,
