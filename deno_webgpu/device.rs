...
impl GPUDevice {
  ...
  fn create_bind_group_layout(
    ...
    let id = self.instance.device_create_bind_group_layout(
      self.id,
      &wgpu_descriptor,
      None,
    ).unwrap();
  ...
  fn create_pipeline_layout(
    ...
    let id = self.instance.device_create_pipeline_layout(
      self.id,
      &wgpu_descriptor,
      None,
    ).unwrap();
  ...
  fn create_command_encoder(
    ...
    let id = self.instance.device_create_command_encoder(
      self.id,
      &wgpu_descriptor,
      None,
    ).unwrap();
...
impl GPUDevice {
  fn new_compute_pipeline(
    ...
    let id = self.instance.device_create_compute_pipeline(
      self.id,
      &wgpu_descriptor,
      None,
    ).unwrap();
  ...
  fn new_render_pipeline(
    ...
    let id = self.instance.device_create_render_pipeline(
      self.id,
      &wgpu_descriptor,
      None,
    ).unwrap();
